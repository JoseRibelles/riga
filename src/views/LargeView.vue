  ...
  <ion-page class="menu-page">
    <ion-header class="ion-no-border">
      <ion-toolbar class="menu-toolbar">
        ...
        <ion-title class="menu-title">LARGE MENÚ</ion-title>
      </ion-toolbar>
    </ion-header>
...
const pizzas = ref([
  { name: '4 Cheese',           desc: 'Catupiry, mozzarella, cream cheese, and parmesan.',                                                          image: 'https://www.figma.com/api/mcp/asset/a7ba6493-4afd-4773-a69d-5018210af0d9', qty: 0 },
  { name: 'Chicken with cheese', desc: 'Chicken and cream cheese.',                                                                                  image: 'https://www.figma.com/api/mcp/asset/1b5f4589-3472-49a9-addd-73bfdf00e61a', qty: 0 },
  { name: 'Pepperoni',           desc: 'Calabrese sausage and mozzarella.',                                                                          image: 'https://www.figma.com/api/mcp/asset/27bbca78-b1f3-468b-9650-43d2447b2d53', qty: 0 },
  { name: 'Napolitana',          desc: 'Cheese, tomato, and Parmesan.',                                                                              image: 'https://www.figma.com/api/mcp/asset/46d8e29f-be2e-4311-a2e1-c1f0f98280c6', qty: 0 },
  { name: 'Pepperoni olives',    desc: 'Cheese, pepperoni, black olives, grated Parmesan, oregano, granulated garlic, and cream cheese.',             image: 'https://www.figma.com/api/mcp/asset/0aa5a9b6-cb00-4414-b9eb-2dd07342df76', qty: 0 },
  { name: 'Margherita',          desc: 'Cheese, tomato, and basil.',                                                                                 image: 'https://www.figma.com/api/mcp/asset/17d2d3f7-eef5-494e-9456-7612620df477', qty: 0 },
  { name: 'Vegetariana',         desc: 'Cheese, mushrooms, black olives, onion, oregano, and green bell pepper.',                                    image: 'https://www.figma.com/api/mcp/asset/3706035e-7e7e-4b6e-ae53-3f3d4f2e969e', qty: 0 },
  { name: 'Bacon',               desc: 'Bacon, tomato, and pepperoni.',                                                                              image: 'https://www.figma.com/api/mcp/asset/7a5500cf-6066-495a-9a6b-45d46cedc0fa', qty: 0 },
  { name: '3 Cheese',            desc: 'Catupiry, mozzarella, and cream cheese.',                                                                    image: 'https://www.figma.com/api/mcp/asset/437f02ac-56bd-49dc-aa2b-bdba240ea2fe', qty: 0 },
])
